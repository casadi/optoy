# -*- coding: utf-8 -*-
#
# Optoy documentation build configuration file, created by
# sphinx-quickstart on Wed Oct 22 08:24:46 2014.
#
...
latex_documents = [
  ('index', 'Optoy.tex', u'Optoy Documentation',
   u'Joris Gillis', 'manual'),
]
...
man_pages = [
    ('index', 'optoy', u'Optoy Documentation',
     [u'Joris Gillis'], 1)
]
...
texinfo_documents = [
  ('index', 'Optoy', u'Optoy Documentation',
   u'Joris Gillis', 'Optoy', 'One line description of project.',
   'Miscellaneous'),
]
